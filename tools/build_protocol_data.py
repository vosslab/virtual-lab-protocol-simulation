...
def validate_items(items, repo_root, reagents):
	...
	required_scenes = {'cell_culture_hood', 'bench', 'overlay', 'virtual', 'none', 'well_plate_workspace'}
...
def validate_steps(steps, items, reagents, parts, days):
	...
	valid_scenes = {'cell_culture_hood', 'bench', 'incubator', 'microscope', 'well_plate_workspace', 'plate_reader'}
