...
const PLATE_REVIEW_PROTOCOL =
  process.env.PLATE_REVIEW_PROTOCOL || "tutorial_plate_drug_additions";
...
async function main() {
  ...
  await page.waitForSelector("#plate-overlay.active .plate-workspace-svg", {
    timeout: 5000,
  });
  await page.screenshot({
