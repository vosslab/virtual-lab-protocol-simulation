  ...
  try {
    ...
    try {
      ...
      if (
        ...
        console.log(
          "[PASS] Test 2: pbs_wash source click with tool ready (indexDelta: 1)",
        );
        passCount++;
      } else {
    ...
    try {
      ...
      if (
        ...
        console.log(
          "[PASS] Test 3: pbs_wash source click without tool (wrong_order)",
        );
        passCount++;
      } else {
    ...
    try {
      ...
      if (
        ...
        console.log(
          "[PASS] Test 4: pbs_wash destination click with held liquid (indexDelta: 1)",
        );
        passCount++;
      } else {
        console.log(
          "[FAIL] Test 4: pbs_wash destination click with held liquid",
        );
        console.log("  Result:", JSON.stringify(result));
      }
    } catch (err) {
    ...
    try {
      ...
      if (result.kind === "no-op") {
        console.log(
          "[PASS] Test 6: step without interactionSequence returns no-op",
        );
        passCount++;
      } else {
    ...
    try {
      ...
      if (result.kind === "no-op") {
        console.log(
          "[PASS] Test 7: directTool step returns no-op (not resolver scope)",
        );
        passCount++;
      } else {
    ...
    try {
      ...
      if (
        ...
        console.log(
          "[PASS] Test 8: aspirate_old_media tool click (indexDelta: 0)",
        );
        passCount++;
      } else {
    ...
    try {
      ...
      if (
        ...
        console.log(
          "[PASS] Test 9: aspirate_old_media source click with tool ready (indexDelta: 1)",
        );
        passCount++;
      } else {
        console.log(
          "[FAIL] Test 9: aspirate_old_media source click with tool ready",
        );
        console.log("  Result:", JSON.stringify(result));
      }
    } catch (err) {
