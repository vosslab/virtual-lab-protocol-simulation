...
/* global CARB_CONC_BY_ROW_UM, COL_LABELS, PLATE_96_COLS, PLATE_96_ROWS, ROW_LABELS, applyPlateDoseMap, gameState, getCarbConcUm, hasMetformin */
...
async function runTests(page) {
  ...
  try {
    ...
    const pass =
      result.well00CarbOk && result.well37CarbOk && result.well76CarbOk;
    results.push({
