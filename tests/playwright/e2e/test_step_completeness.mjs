...
async function runCompletenesTest(page) {
	...
	console.log('Test 1: Used items must be in required items or be virtual targets');
	...
	console.log('Test 5: aspirate_old_media has waste_container in required and used');
