...
import {
	...
	loadScene,
	SceneId,
} from '../src/scene_runtime/loader/scene';
import {
	setObjectCatalog,
	loadObject,
	ObjectId,
...
import { PROTOCOL_CATALOG } from '../generated/protocol_data';
...
function main(): void {
	...
	if (!sceneId) {
		throw new Error(`No scenes with placements found in protocol '${protocolName}'`);
	}
