// ============================================
// plate.ts - Plate scene renderer and modal overlay
// ============================================

import { getCurrentStep, gameState, registeredEmitters, switchScene, triggerStep } from "../game_state";


// These are the step ids this scene owns. The YAML completionEvent strings
// ('tutorial-plate-opened', 'tutorial-plate-submitted') are a separate namespace.
...
// SP-K2e).
// ============================================
export function renderPlateScene(): void {
	const overlay = document.getElementById('plate-overlay');
	if (!overlay) {
