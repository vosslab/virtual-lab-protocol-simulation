...
* All students must dispose of biological waste materials in the biohazard bin, and non-biological waste should be disposed of in the regular bin.
...
**Reviewing student**: Gary
Things to do one week or one day before the day of lab.
...
**Stage 1: Forward Extraction**

1. Adjust pH: Use 2.5 M NaOH and 0.1 M HCl to adjust the pH of your crude extract to 8.0.( 4ml)
2. Prepare Organic Solution: Create a solution of 0.1 M AOT (bis(2-ethylhexyl) sulfosuccinate sodium) dissolved in isooctane.( 4 ml)
3. Mix Phases: Combine equal volumes of the pH-adjusted aqueous extract and the organic AOT solution in a centrifuge tube.
4. Agitate: Shake the mixture gently for 10 minutes.
5. Centrifuge: Run the centrifuge at 4000 x g for 5 minutes to achieve clear separation.
6. Collect: Discard the bottom aqueous phase and retain the top organic layer, which now contains the protein.


**Stage 2: Backward Extraction (Stripping)**

1. Prepare Stripping Buffer: Create an aqueous solution consisting of 0.02 M phosphate buffer (pH 11.0) and 0.5 M NaCl.
2. Mix Phases: Combine the retained organic phase from Stage 1 with an equal volume of this new stripping buffer.
3. Agitate: Shake the mixture for 20 minutes to ensure the protein transfers back into the aqueous phase.
4. Centrifuge: Run at 4000 x g for 5 minutes.
5. Final Collection: Retain the bottom aqueous phase, which now contains the partially purified miraculin. This method can achieve a purity of approximately 94.8%.

### Part 1: Breaking the Cells

**Assigned student**: Bansari
**Reviewing student**: Gary
Motar pestle, coffee grinder
...
Total time of fixed timed steps: xxx
Estimated time of all steps: xxx
