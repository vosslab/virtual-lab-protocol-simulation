...
| `generated/` | Gitignored; SVG asset modules regenerated by [pipeline/generate_svg_globals.py](../pipeline/generate_svg_globals.py). See [specs/SVG_PIPELINE.md](specs/SVG_PIPELINE.md). |
...
### [validation/](../validation/) - Protocol and scene validators

Standalone YAML validators and audit tools for schema, structure, and logical consistency.

#### [validation/yaml/](../validation/yaml/) - Protocol and scene YAML validator
...
#### [validation/stepper/](../validation/stepper/) - Protocol step-flow validator
...
#### [validation/svg/](../validation/svg/) - SVG asset validator
...
#### [validation/manual/](../validation/manual/) - Human-readable protocol manual
...
#### [validation/shared_toolkit/](../validation/shared_toolkit/) - Shared utilities
...
### [tools/](../tools/) - Runtime and development utilities

Build wrappers, browser testing, and SVG helpers. Content tooling moved to [pipeline/](../pipeline/) and [validation/](../validation/).
...
[pipeline/generate_svg_globals.py](../pipeline/generate_svg_globals.py). Sidecar
...
| `generated/svg_assets/*.ts` (per-asset SVG constants + `index.ts` barrel) | [pipeline/generate_svg_globals.py](../pipeline/generate_svg_globals.py) |
| `generated/svg_manifest.ts` (`SVG_IDS`, `SVG_GROUPS`) | [pipeline/generate_svg_globals.py](../pipeline/generate_svg_globals.py) |
| `generated/protocol_data.ts`, `generated/inventory_data.ts`, `generated/scene_data.ts` (gitignored, regenerated; consumed via `src/protocol.ts`, `src/inventory.ts`, `src/scene_configs.ts` facades) | [pipeline/build_protocol_data.py](../pipeline/build_protocol_data.py), [pipeline/build_scene_data.py](../pipeline/build_scene_data.py) |
