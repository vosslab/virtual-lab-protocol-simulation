...
compiled into TypeScript modules by [build_protocol_data.py](../pipeline/build_protocol_data.py)
...
- `generated/svg_assets/<name>.ts` - Per-asset SVG string constants
  ...
  [generate_svg_globals.py](../pipeline/generate_svg_globals.py).
...
- **Generated TypeScript artifacts (gitignored):**
  - `generated/protocol_data.ts` - Protocol steps and metadata
    (emitted by [build_protocol_data.py](../pipeline/build_protocol_data.py)).
  ...
  - `generated/scene_data.ts` - Scene configurations and registrations
    (emitted by [build_scene_data.py](../pipeline/build_scene_data.py)).
  - `generated/svg_assets/*.ts` - Per-asset SVG string constants
    (emitted by [generate_svg_globals.py](../pipeline/generate_svg_globals.py)).
...
1. [build_protocol_data.py](../pipeline/build_protocol_data.py) parses
   ...
   gate.
2. [generate_svg_globals.py](../pipeline/generate_svg_globals.py) reads
...
1. **SVG art** owns shapes and stable ids. Liquid sub-objects carry ids
   ...
   `liquid_residue`.
2. **Generator** ([generate_svg_globals.py](../pipeline/generate_svg_globals.py))
...
- **New protocol steps:** edit
  ...
  re-run [build_protocol_data.py](../pipeline/build_protocol_data.py).
