...
- Live-work signals: [docs/TODO.md](../TODO.md), [docs/ROADMAP.md](../ROADMAP.md),
  latest two day blocks of [docs/CHANGELOG.md](../CHANGELOG.md)
...
| 122 | `docs/active_plans/new2_css_native_best_case_showcase_assets/` | tracked | 6.3M | DELETE:generated | Asset dir for ARCHIVE row #44 (37 lane_* assets including HTML/PNG/MD/TXT) | - | regenerable from test-results + experiments/css_native_layout precheck output | - |
...
4. The two `workstreams/`-routing heuristic calls (rows 4, 5, 48, 50, 55, 56,
   57) match user intent for the two-tier split.
