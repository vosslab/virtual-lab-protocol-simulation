...
Run at: 2026-07-04 23:29:47 UTC
...
| hemocytometer_view | 0 | 1 | 8 | FAIL: Structural guard failure (item overlap): item "rear_ethanol_bottle" overlaps with "right_hemocytometer_slide_clear" by 100.0%. | 0 | 0 |
| hood_basic | 0 | 1 | 10 | PASS | 0 | 0 |
| hood_workspace | 0 | 1 | 12 | PASS | 0 | 0 |
| imaging_bench | 0 | 1 | 12 | PASS | 0 | 0 |
| incubator_workspace | 0 | 1 | 9 | PASS | 0 | 0 |
| microscope_basic | 1 | 1 | 6 | FAIL: Structural guard failure (item overlap): item "rear_ethanol_bottle" overlaps with "right_hemocytometer_slide" by 43.0%. | 0 | 0 |
...
| passage_hood_detachment_microscope_view | 0 | 2 | 5 | FAIL: Structural guard failure (item overlap): item "left_cell_suspension" overlaps with "instrument_t75_flask" by 9.6%. | 0 | 0 |
...
**Guard verdict:** FAIL
**Guard failure message:** Structural guard failure (item overlap): item "rear_ethanol_bottle" overlaps with "right_hemocytometer_slide_clear" by 100.0%.

**Diagnostics:** 0 (passes: 1, final items: 8)
(none)
...
**Guard verdict:** FAIL
**Guard failure message:** Structural guard failure (item overlap): item "rear_ethanol_bottle" overlaps with "right_hemocytometer_slide" by 43.0%.

**Diagnostics:** 1 (passes: 1, final items: 6)
...
**Guard verdict:** FAIL
**Guard failure message:** Structural guard failure (item overlap): item "left_cell_suspension" overlaps with "instrument_t75_flask" by 9.6%.

**Diagnostics:** 0 (passes: 2, final items: 5)
(none)
...
- **hemocytometer_view**: Structural guard failure (item overlap): item "rear_ethanol_bottle" overlaps with "right_hemocytometer_slide_clear" by 100.0%.
- **microscope_basic**: Structural guard failure (item overlap): item "rear_ethanol_bottle" overlaps with "right_hemocytometer_slide" by 43.0%.
- **passage_hood_detachment_microscope_view**: Structural guard failure (item overlap): item "left_cell_suspension" overlaps with "instrument_t75_flask" by 9.6%.
