...
[normalize_svg_v3_wild_verdicts.md](normalize_svg_v3_wild_verdicts.md) and
[normalize_svg_v3_wild_verdicts.json](normalize_svg_v3_wild_verdicts.json)):
...
[normalize_svg_v3_parity.md](normalize_svg_v3_parity.md) and
[normalize_svg_v3_parity.json](normalize_svg_v3_parity.json)):
...
[svg_visual_regression.md](svg_visual_regression.md) and
[svg_visual_regression.json](svg_visual_regression.json); ~48 min for 300
...
- [normalize_svg_v3_wild_verdicts.md](normalize_svg_v3_wild_verdicts.md) -- per-reason-code counts over 3125 wild files
- [normalize_svg_v3_wild_verdicts.json](normalize_svg_v3_wild_verdicts.json) -- per-file JSON verdicts
- [normalize_svg_v3_parity.md](normalize_svg_v3_parity.md) -- v2 vs v3 comparison on 102 committed assets
- [normalize_svg_v3_parity.json](normalize_svg_v3_parity.json) -- parity data in JSON
- [svg_visual_regression.md](svg_visual_regression.md) -- imagehash chromium+firefox, 300-file sample
- [svg_visual_regression.json](svg_visual_regression.json) -- per-file hash distances
- [../audits/normalize_svg_v2_audit.md](../audits/normalize_svg_v2_audit.md) -- v2 audit with v3 resolution notes
