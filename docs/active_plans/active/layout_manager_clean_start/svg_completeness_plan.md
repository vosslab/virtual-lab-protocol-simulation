...
- [docs/PRIMARY_CONTRACT.md](../../../PRIMARY_CONTRACT.md) item 3:
  ...
  engine.
- [docs/PRIMARY_DESIGN.md](../../../PRIMARY_DESIGN.md): never crop
  scientific SVG assets.
- [docs/specs/SVG_PIPELINE.md](../../../specs/SVG_PIPELINE.md): asset
...
5. **No-crop diagnostic remains hard fail.** Section 9 here does not
   ...
   [docs/PRIMARY_DESIGN.md](../../../PRIMARY_DESIGN.md). A real SVG
...
recomputable). Per
[docs/PYTHON_STYLE.md](../../../PYTHON_STYLE.md) the underscore-prefixed
...
- [docs/active_plans/active/layout_manager_clean_start/ONBOARDING.md](ONBOARDING.md) -
