...
3. **Clickable objects are SVG-backed scene objects laid out by the layout engine.**
   ...
   See [specs/LAYOUT_ENGINE.md](specs/LAYOUT_ENGINE.md). All liquids in objects are handled by [specs/LIQUID_CONVENTION.md](specs/LIQUID_CONVENTION.md). Liquids should not be hard-coded into objects. This will take effort before inserting a new asset.
