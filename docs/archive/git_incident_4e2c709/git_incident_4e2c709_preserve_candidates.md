...
- docs/active*plans/new2_css_native_best_case_showcase_assets/lane_a_gallery*\* (8 PNGs)
- docs/active_plans/new2_no_crop_audit_assets/ (~48 PNGs)

### Duplicate gallery/evidence PNGs

- new2*css_native_best_case_showcase_assets/lane_b/e/f/g/h/n/o2/p2/q*\*.png
