...
No collisions with cell*culture. All shared ids are intentional reuses of universal lab equipment names. Tutorials introduce no `dilution_tube*\*` items, so the carb/metformin namespace is clean.
