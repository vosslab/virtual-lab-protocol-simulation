...
- This doc documents the standard. Updating the existing color palette in
  `QUESTION_STATEMENT_EMPHASIS.md` (not yet written) is a follow-up task.

## Related documentation

- `QUESTION_STATEMENT_EMPHASIS.md` (planned) - Current color definitions
- `COLOR_TEXT_IN_WEBWORK.md` (planned) - Color text rendering in WeBWorK
